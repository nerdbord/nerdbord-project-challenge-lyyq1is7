  ...
  return (
    <div className="current-month-container">
      <div className="current-month-container-items">
        ...
        <ul className="current-month-container-item-icons">
          <li>diagram icon</li>
          <li>share icon</li>
        </ul>
      </div>
      <div className="current-month-container-card">
        <div className="current-month-container-card-items-1">
          <h3 className="current-month-container-card-items-month">Jully 2024</h3>
        ...
        <div className="current-month-container-card-items-2">
            ...
            <div className="current-month-container-card-items-spends-sum"><span>-1800,75 $</span></div>
        </div>
      </div>
    </div>
  );
